                ...
                <div class="container">
                    ...
                    <div class="bradcaump__inner">
                                <nav class="bradcaump-inner">
                                  ...
                                  <a class="breadcrumb-item" href="category.php?cate_id=<?php echo $getProduct['0']['cate_id'];?>">
                                  <?php echo $getProduct ['0']['cate_name'];?></a>
                                  <span class="brd-separetor"><i class="zmdi zmdi-chevron-right"><?php echo $getProduct['0']['product_name'];?></i></span>
