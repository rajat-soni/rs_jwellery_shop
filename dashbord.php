    ...
    <nav class="navbar navbar-dark bg-info p-3">
        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <main class="col-md-9 ml-sm-auto col-lg-10 px-md-4 py-4 mb-4">
                    ...
                    <p>This is the homepage of a simple admin interface which is part </p>
                    <div class="row">
                        <div class="col-md-3 sm-12 lg-4 xl-3">
                            <div class="card">
                    ...
                    <div class="row mt-4">
                      ...
                      <hr class="mt-4">
                      <footer class="mt-1 d-flex justify-content-between">
