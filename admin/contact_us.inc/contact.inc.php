...
?>
    ...
    <div class="container">
            <div class="row">
                ...
                <div class="col-md-5" style="margin-top: -0px; margin-left:-12px;" >
                ...
                <div class="col-md-7 bg- mt-4 mb-4 p-4">
                  <form method= "POST" action = "contactData.inc.php">
                    <div class="row p-2">
                        <div class="col-25 ">
                    ...
                    <div class="row p-2">
                        ...
                        <div class="col-75">
                            ...
                            <input type="submit" name="submit" class="btn btn-success btn-md mt-2" class="form-control">
